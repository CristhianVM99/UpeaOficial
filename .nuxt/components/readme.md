...
- `<HomeOnlineAcademyBannerPrincipal>` | `<home-online-academy-banner-principal>` (components/home-online-academy/BannerPrincipal.vue)
...
- `<HomeOnlineAcademyMain>` | `<home-online-academy-main>` (components/home-online-academy/Main.vue)
...
- `<MainMediosUpera>` | `<main-medios-upera>` (components/main/MediosUpera.vue)
