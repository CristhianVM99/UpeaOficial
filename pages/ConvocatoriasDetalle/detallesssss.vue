            ...
            <div class="container">
                <div class="breadcrumb-inner">
                    <ul class="edu-breadcrumb">
                        ...
                        <li class="breadcrumb-item"><n-link :to="'/convocatorias/'+$route.params.detalle">{{ $route.params.detalle }}</n-link></li>
                        <li class="separator"><i class="icon-angle-right"></i></li>
                        <li class="breadcrumb-item active" aria-current="page">{{ $route.params.detalle}} detalle</li>
                    </ul>
                    <div class="page-title">
                        <h1 v-if="($route.params.detalle == 'publicaciones')" class="title">{{ coleccion.publicaciones_titulo }}</h1>
                        <h1 v-if="($route.params.detalle == 'gacetas')" class="title">{{ coleccion.gaceta_titulo }}</h1>
                        <h1 v-if="($route.params.detalle == 'eventos')" class="title">{{  coleccion.evento_titulo }}</h1>
                        <h1 v-if="($route.params.detalle == 'videos')" class="title">{{ coleccion.video_titulo }}</h1>                        
                    </div>
                    <ul class="course-meta">
                        <li><i class="icon-58"></i>Upea</li>
                        <li><i class="icon-59"></i>Universidad Publica de El Alto</li>
                    ...
                    <div class="col-lg-8">
                        <div class="course-details-content course-details-2">
                            <div class="course-overview">
                                <h3 v-if="($route.params.detalle != 'gacetas')" class="heading-title" data-aos-delay="150" data-aos="fade-up" data-aos-duration="800">Descripcion</h3>
                                <p v-html="coleccion.publicaciones_descripcion" v-if="($route.params.detalle == 'publicaciones')" data-aos-delay="150" data-aos="fade-up" data-aos-duration="800"></p>
                                <p v-html="coleccion.evento_descripcion" v-if="($route.params.detalle == 'eventos')" data-aos-delay="150" data-aos="fade-up" data-aos-duration="800"></p>
                                <p v-html="coleccion.video_breve_descripcion" v-if="($route.params.detalle == 'videos')" data-aos-delay="150" data-aos="fade-up" data-aos-duration="800"></p>
